...
//Uang
let uangm = Math.floor(Math.random() * 10) + 400
let duit = Math.floor(Math.random() * 20) + 250
let duitm = Math.floor(Math.random() * 50) + 950
let duitd = Math.floor(Math.random() * 62) + 520
let duitr = Math.floor(Math.random() * 20) + 420
let duitk = Math.floor(Math.random() * 70) + 780
//ANJAY
