...
if (!args[0] || !args[1]) throw `• *Example :* ${usedPrefix}${command} daffz 6288980870067`
try {
...
"body": JSON.stringify({
"name": args[0],
"description": "Dont Forget Subs YT Channel @DaffzOfficial",
"user": user.id,
"egg": parseInt(15),
...
kata += cid
await conn.reply('120363262065845429@g.us', kata, null)
} else {
